...
namespace RocketBot2.Forms
{
    partial class AuthAPIForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.radHashServer.Text = "PogoDev Hash Server API - " + Configuration.Hasher.PokemonVersion;
    ...
    "r 2-3 normal bots.";
            ...
            this.radCustomHash.Text = "Custom Hash Server API - " + Configuration.Hasher.PokemonVersion;
