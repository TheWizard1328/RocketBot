    ...
    public class MultiAccountManager
    {
        ...
        public void UpdateLocalAccount(Account current, bool save = true)
        {
            ...
            if (localAccount != null)
            {
                ...
                localAccount.AccountLatitude = string.IsNullOrEmpty(current.AccountLatitude.ToString()) ? Client.ClientSession.Player.Latitude : current.AccountLatitude;
                localAccount.AccountLongitude = string.IsNullOrEmpty(current.AccountLongitude.ToString()) ? Client.ClientSession.Player.Longitude : current.AccountLongitude;
