...
namespace PoGo.NecroBot.Logic.Strategies.Walk
{
    class FlyStrategy : BaseWalkStrategy
    {
        ...
        {
            var curLocation = new GeoCoordinate(_client.ClientSession.Player.Latitude, _client.ClientSession.Player.Longitude);
            ...
            if (dist >= 100)
            {
                ...
                do
                {
                    ...
                    curLocation = new GeoCoordinate(_client.ClientSession.Player.Latitude, _client.ClientSession.Player.Longitude);
