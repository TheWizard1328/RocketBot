...
#pragma warning disable IDE0018 // Inline variable declaration - Build.Bat Error Happens if We Do
            ...
            ulong encounterId;
            var distance = LocationUtils.CalculateDistanceInMeters(new GeoCoordinate(session.Client.ClientSession.Player.Latitude, session.Client.ClientSession.Player.Longitude), new GeoCoordinate(data.Latitude, data.Longitude));
