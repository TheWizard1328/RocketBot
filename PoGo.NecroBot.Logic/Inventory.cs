...
namespace PoGo.NecroBot.Logic
{
    public class Inventory
    {
            ...
            Action onUpdated = null)
        {
            ...
            /*/TODO: Inventory update will be called everytime GetMapObject is called.
            client.ClientSession.InventoryUpdate += delegate { 
        ...
        public async Task<IEnumerable<InventoryItem>> GetCachedInventory()
        {
            ...
            return _client.ClientSession.Player.Inventory.InventoryItems;
        }
        ...
        public async Task UseLuckyEgg()
        {
            ...
            switch (useItemXpBoostResponse.Result)
            {
        ...
        public async Task<MoveSettings> GetMoveSetting(PokemonMove move)
        {
            ...
            var moveSettings = _client.ClientSession.Templates.ItemTemplates.Where(x => x.MoveSettings != null)
        ...
        public async Task<IEnumerable<PokemonSettings>> GetPokemonSettings()
        {
            await Task.Delay(0); //remove warn
            if (!_client.LoggedIn)
                return new List<PokemonSettings>();
            ...
            if (_pokemonSettings == null)
            {
                ...
                _pokemonSettings = _client.ClientSession.Templates.ItemTemplates.Select(i => i.PokemonSettings)
        ...
        public async Task<LevelUpRewardsResponse> GetLevelUpRewards(int level)
        {
            ...
            if (_level == 0 || level > _level)
            {
                ...
                foreach (var item in levelUpRewardsResponse.ItemsAwarded)
                {
                    await UpdateInventoryItem(item.ItemId).ConfigureAwait(false);
                }
            }
            return levelUpRewardsResponse;
        }
